...
class DigitalMeMod(Module):
    ...
    def __init__(self) -> None:
        ...
        self.config = ModuleConfig(
            ...
            ConfigValue("max_output_tokens", 1000, "Maximum completion tokens", validators.Integer(minimum=64, maximum=8192)),
            ConfigValue("timeout_seconds", 60, "Provider timeout", validators.Integer(minimum=5, maximum=300)),
            ConfigValue("context_window_override", 8192, "Model context budget", validators.Integer(minimum=2048, maximum=131072)),
            ...
            ConfigValue("recent_messages_limit", 40, "Recent context bubbles", validators.Integer(minimum=6, maximum=100)),
            ConfigValue("rag_result_count", 10, "RAG examples", validators.Integer(minimum=0, maximum=20)),
            ConfigValue("max_message_bubbles", 5, "Maximum reply bubbles", validators.Integer(minimum=1, maximum=12)),
            ConfigValue("max_message_length", 1200, "Maximum bubble length", validators.Integer(minimum=64, maximum=4096)),
